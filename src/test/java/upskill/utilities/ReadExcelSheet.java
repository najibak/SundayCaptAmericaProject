...
public class ReadExcelSheet {
	...
	public static Map<String, Map<String, String>> setMapData() throws Exception{       //Nested Hashmap - Setter Method
		
		String path = System.getProperty("user.dir")+"/src/test/resource/Datasheets/EbayDataSheet.xlsx";  //path for excel file
		...
		for (int i = 0; i<=lastRow; i++){					//Looping over entire row
			...
			dataMap.put(key, value);						//Putting key & value in dataMap(Storing in hashmap(datamap))
